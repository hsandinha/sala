...
// Índice para garantir que um usuário só tenha um endereço (se usuario_id for unique)
// Se você optar por não ter 'unique: true' em usuario_id, pode remover este índice.
// enderecoSchema.index({ usuario_id: 1 }, { unique: true }); // Já garantido pelo unique:true no campo
